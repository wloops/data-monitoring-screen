...
import api from '@/api'
import { mainBase } from '@/utils/baseParams'
...
queryItems.value = mainBase.viewDef

api.getRecordMenuGrp(
  {
    tblAlias: 'viewDef'
  }
).then((res) => {
  console.log('getRecordMenuGrp main', res)
})
...
const {
  ...
  name: '文章',
  initForm: { author: '大脸怪' },
  // doCreate: OldApi.addPost,
  // doDelete: OldApi.deletePost,
  // doUpdate: OldApi.updatePost,
